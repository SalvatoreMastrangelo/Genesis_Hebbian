...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--vmin", type=float, default=5.0, help="Minimum commanded speed for evaluation.")
    parser.add_argument("--vmax", type=float, default=25.0, help="Maximum commanded speed for evaluation.")
