...
def evaluation(
    ...
    # Flat mean over all valid envs (no v_cmd-binning, no smoothing).
    ...
    if save_plots:
        ...
        try:
            ...
            print(f"[evaluation] total_plot_points → {total_pts_out}")
        except Exception as exc:
            print(f"[evaluation][error] total_plot_points failed: {exc}")
