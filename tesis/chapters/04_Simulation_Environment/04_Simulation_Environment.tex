...
\end{subfigure}
\caption[Parts and actuators of the drone]{Parts and actuators of the drone. (a) The seven commands, on a schematic top view with the nose up: the throttle of the propeller, the sweep and the twist of each wing panel, the elevator and the rudder. (b) The reference drone with both panels swept back to the limit of their range and twisted in opposite directions, and with the elevator and the rudder deflected; the neutral position of every surface is shown in light grey.}
